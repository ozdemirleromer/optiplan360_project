...
def api_list_maps(
    ...
    items, total = integration_service.list_entity_maps(
        db,
        entity_type,
        skip,
        limit,
...
def api_list_outbox(
    ...
    items, total = integration_service.list_outbox(
        db,
        status,
        skip,
        limit,
...
def api_list_errors(
    ...
    items, total = integration_service.list_errors(
        db,
        is_resolved,
        skip,
        limit,
...
def api_list_audit(
    ...
    items, total = integration_service.list_audit(
        db,
        skip,
        limit,
        entity_type=entity_type,
