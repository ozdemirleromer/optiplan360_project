...
def load_ai_config() -> Dict[str, Any]:
    ...
    try:
        ...
        return {
            ...
            "settings": {"default_temperature": 0.7, "default_max_tokens": 8192, "timeout": 30},
...
async def get_ai_config(
    ...
    try:
        ...
        raise BusinessRuleError(f"AI konfigürasyonu getirilemedi: {str(e)}")
...
async def save_ai_provider_config(
    ...
    try:
        ...
        raise BusinessRuleError(f"AI konfigürasyonu kaydedilemedi: {str(e)}")
    ...
    try:
        ...
        if test_data.provider == "gemini":
            ...
            try:
                ...
                return AIConfigResponse(success=False, message=f"Gemini bağlantı hatası: {str(e)}")
            ...
            return AIConfigResponse(success=False, message="OpenAI entegrasyonu henüz mevcut değil")
            ...
            return AIConfigResponse(success=False, message="Bilinmeyen provider")
        ...
        raise BusinessRuleError(f"AI test işlemi başarısız: {str(e)}")
...
async def switch_ai_provider(
    ...
    try:
        ...
        raise BusinessRuleError(f"Provider değiştirilemedi: {str(e)}")
    ...
    try:
        ...
        if save_ai_config(config):
            ...
            return AIConfigResponse(
                ...
                success=True, message=f"{provider.upper()} konfigürasyonu silindi", config=config
        ...
        raise BusinessRuleError(f"Provider silinemedi: {str(e)}")
...
async def get_ai_status(
    ...
    try:
        ...
        return AIConfigResponse(success=True, message="AI durum bilgileri getirildi", config=status)
        ...
        raise BusinessRuleError(f"AI status alınamadı: {str(e)}")
