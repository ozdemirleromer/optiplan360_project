...
async def generate_text_response(
    ...
    try:
        ...
        raise BusinessRuleError(f"Text response hatası: {str(e)}")
...
async def chat_completion(
    ...
    try:
        ...
        raise BusinessRuleError(f"Chat completion hatası: {str(e)}")
...
async def extract_structured_data(
    ...
    try:
        ...
        raise BusinessRuleError(f"Structured extraction hatası: {str(e)}")
...
async def analyze_document(
    ...
    try:
        ...
        raise BusinessRuleError(f"Document analysis hatası: {str(e)}")
...
async def analyze_image(
    ...
    try:
        ...
        raise BusinessRuleError(f"Image analysis hatası: {str(e)}")
...
async def get_available_models(
    ...
    try:
        ...
        raise BusinessRuleError(f"Models list hatası: {str(e)}")
