...
async def azure_ocr_upload(
    ...
    if not ocr_result.success:
        ...
        raise BusinessRuleError(f"Azure OCR işleme hatası: {ocr_result.error}")
...
async def azure_blob_upload(
    ...
    if not result.success:
        ...
        raise BusinessRuleError(f"Yükleme hatası: {result.error}")
...
async def azure_blob_delete(
    ...
    if not success:
        ...
        raise BusinessRuleError("Dosya silinemedi")
