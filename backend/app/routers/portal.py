...
def get_current_customer(current_user: User = Depends(get_current_user)) -> User:
    ...
    """Oturum aÃ§an kullanÄ±cÄ±nÄ±n bir mÃ¼ÅŸteri (CUSTOMER) hesabÄ± olduÄŸunu doÄŸrular"""
...
def get_customer_dashboard_stats(
    ...
    """MÃ¼ÅŸteri portalÄ± ana ekran istatistiklerini getirir."""




    # SipariÅŸleri bulalÄ±m
    ...
    # Firmaya ait gÃ¼ncel bakiyeyi Ã§ekelim (Mikro entegrasyonu varsa balance alanÄ±)
...
def get_customer_orders(
    ...
    """Sadece mÃ¼ÅŸteriye ait olan geÃ§miÅŸ ve aktif sipariÅŸleri listeler."""
...
def get_customer_invoices(
    ...
    """MÃ¼ÅŸterinin geÃ§miÅŸ faturalarÄ±nÄ± listeler."""
    ...
    if is_paid is not None:
        ...
        status_val = "PAID" if is_paid else "UNPAID"  # PARTIAL durumlarÄ± basite indirgenmiÅŸtir
...
def get_customer_tickets(
    ...
    """MÃ¼ÅŸterinin destek taleplerini listeler."""
    ...
    # Basit liste dÃ¶nÃ¼ÅŸÃ¼nde mesajlarÄ± doldurmaya gerek yok ama ÅŸema uyumu iÃ§in boÅŸ veya dolu gÃ¶nderebiliriz.
...
def create_customer_ticket(
    ...
    """Yeni bir destek talebi (Ticket) oluÅŸturur."""
...
def get_customer_ticket_detail(
    ...
    """Destek talebinin detayÄ±nÄ± ve tÃ¼m mesajlaÅŸma geÃ§miÅŸini getirir."""
    ...
    if not ticket:
        ...
        raise NotFoundError("Destek talebi", None)
...
def reply_to_ticket(
    ...
    """Destek talebine mÃ¼ÅŸteri tarafÄ±ndan yeni bir yanÄ±t ekler."""
    ...
    # Yeni mesaj eklenince ticket'Ä± operatÃ¶r gÃ¶rsÃ¼n diye gÃ¼ncelleyelim.
    ...
    # Sender_name doldurmak iÃ§in manuel dÃ¶nÃ¼ÅŸ:




    # PortalTicketMessageOut ÅŸemasÄ±na uyduruyoruz
