        ...
        return [
            {
                ...
                "Durum": order.status,
                "Tarih": order.created_at.strftime("%d.%m.%Y") if hasattr(order, 'created_at') else "",
                "Teslim Tarihi": order.delivery_date.strftime("%d.%m.%Y") if hasattr(order, 'delivery_date') and order.delivery_date else "",
        ...
        return [
            {
                ...
                "Kayıt Tarihi": customer.created_at.strftime("%d.%m.%Y") if hasattr(customer, 'created_at') else "",
            }
        ...
        return [
            {
                ...
                "Fatura Tarihi": invoice.invoice_date.strftime("%d.%m.%Y") if hasattr(invoice, 'invoice_date') else "",
                "Son Ödeme": invoice.due_date.strftime("%d.%m.%Y") if hasattr(invoice, 'due_date') else "",
            }
