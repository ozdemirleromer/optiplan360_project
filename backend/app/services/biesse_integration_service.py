...
OptiPlan 360 ile Biesse OptiPlanning sistemleri arasÄ±ndaki veri akÄ±ÅŸÄ±nÄ± yönetir
...
class BiesseIntegrationService:
    ...
    def sync_materials_bidirectional(self) -> Dict[str, Any]:
        ...
        Ä°ki yönlü malzeme senkronizasyonu
        ...
        try:
            ...
            logger.error(f"Ä°ki yönlü senkronizasyon hatasÄ±: {str(e)}")
    ...
    def _parse_opjx_file(self, file_path: str) -> Dict[str, Any]:
        ...
        # Basit implementasyon - gerçek OPJX formatÄ±na göre güncellenmeli
    ...
    def _generate_opjx_content(self, job_data: Dict[str, Any]) -> str:
        ...
        """OPJX dosya içeriÄŸi oluÅŸturur"""
...
"""
    ...
    def _run_optiplanning(self, opjx_file: Path) -> bool:
        ...
        try:
            ...
            # OptiPlanning'i subprocess ile çalÄ±ÅŸtÄ±r
            ...
            result = subprocess.run(
                ...
                [str(exe_path), "-f", str(opjx_file), "-a"],  # Otomatik çalÄ±ÅŸtÄ±r
            ...
            logger.error(f"OptiPlanning çalÄ±ÅŸtÄ±rma hatasÄ±: {str(e)}")
    ...
    def _get_pending_opjx_files(self) -> List[str]:
        ...
        try:
            ...
            # Basit implementasyon - gerçek mantÄ±ÄŸa göre güncellenmeli
