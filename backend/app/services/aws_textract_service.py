...
class AWSTextractService:
    ...
    def is_configured(self) -> bool:
        ...
        return (
            self._get_config("aws_textract_access_key") is not None and
            self._get_config("aws_textract_secret_key") is not None
        )
    ...
    async def analyze_document(self, image_data: bytes, feature_types: List[str] = None) -> AWSTextractResult:
        """
