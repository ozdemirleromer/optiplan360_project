...
class DropOptimizationService:
    ...
    def set_min_dimensions(self, 
                          min_boy: float = 50.0,
                          min_en: float = 50.0,
                          min_alan: Optional[float] = None) -> MinChangeableDimensions:
        """
    ...
    def calculate_optimization(self,
                               ...
                               grain_code: str = "0-Material") -> DropOptimizationResult:
        """
    ...
    def optimize_order_parts(self,
                            parts: List[Dict],
                            grain_code: str = "0-Material") -> List[DropOptimizationResult]:
        """
    ...
    def get_optimization_summary(self, results: List[DropOptimizationResult]) -> Dict:
        ...
        ort_kazanc_yuzde = sum(r.kazanc_yuzde for r in results) / toplam_parca if toplam_parca > 0 else 0
        ...
        return {
            ...
            "optimizasyon_orani": round(optimize_edilen / toplam_parca * 100, 1) if toplam_parca > 0 else 0
        }
    
    def apply_to_export(self,
                       part_data: Dict,
                       grain_code: str = "0-Material") -> Dict:
        """
        ...
        result = self.calculate_optimization(
            boy=part_data.get('boy', 0),
            en=part_data.get('en', 0),
            grain_code=grain_code
        )
