...
from app.models import Customer, Order, StockCard, User
...
class AIAssistantService:
    ...
    async def analyze_business_data(
        self, user_id: str, analysis_type: str = "general"
    ) -> Dict[str, Any]:
        """
    ...
    async def generate_business_report(
        self, user_id: str, report_type: str = "weekly", custom_prompt: Optional[str] = None
    ) -> Dict[str, Any]:
        """
        İş raporu üretir
        ...
        try:
            ...
            # Sipariş verileri
            orders = db.query(Order).filter(Order.created_at >= filter_date).all()
            ...
            report_data = {
                ...
                "orders": {"total": len(orders), "by_status": {}, "by_material": {}},
            }
            ...
            for order in orders:
                ...
                report_data["orders"]["by_material"][material] = (
                    report_data["orders"]["by_material"].get(material, 0) + 1
                )
    ...
    async def smart_search(
        self, user_id: str, query: str, search_scope: str = "all"
    ) -> Dict[str, Any]:
        """
        Akıllı arama yapar
    ...
    async def get_recommendations(
        ...
        try:
            ...
            recent_orders = (
                db.query(Order)
                .filter(Order.created_at >= datetime.now() - timedelta(days=7))
                .limit(20)
                .all()
            )
            ...
            recommendation_data = {
                ...
                "recent_activity": {
                    ...
                    "common_materials": list(
                        set([o.material_name for o in recent_orders if o.material_name])
                    ),
