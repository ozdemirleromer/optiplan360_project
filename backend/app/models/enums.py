...
class JobErrorCode(str, enum.Enum):
    ...
    NO_PARTS = "E_NO_PARTS"
    BACKING_THICKNESS_UNKNOWN = "E_BACKING_THICKNESS_UNKNOWN"
    TRIM_RULE_MISSING = "E_TRIM_RULE_MISSING"
    LOCAL_PROCESSING = "E_LOCAL_PROCESSING"
    WORKER_ENV_UNSUPPORTED = "E_WORKER_ENV_UNSUPPORTED"
    OPTI_WORKER_FAILED = "E_OPTI_WORKER_FAILED"
    OPTI_XML_TIMEOUT = "E_OPTI_XML_TIMEOUT"
    XML_INVALID = "E_XML_INVALID"
    OSI_ACK_FAILED = "E_OSI_ACK_FAILED"
    OSI_ACK_TIMEOUT = "E_OSI_ACK_TIMEOUT"
