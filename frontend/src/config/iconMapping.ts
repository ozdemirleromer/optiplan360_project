 ...
 * [x] LoginPage - Form validation icons


 * [x] OrdersTable - Edit, Delete, View, Export icons


 * [x] StationsPage - Add, Edit, Delete, Settings icons


 * [x] AdminPanel - Settings, Users, Chart icons


 * [x] FormComponents - Success, Error, Info indicators


 * [x] Modal - Close button icon, status icons


 * [x] DataTable - Sort, Filter, Pagination icons


 * [x] Dashboard - Chart, Card header icons


 * [x] StatusBadges - Status indicator icons
