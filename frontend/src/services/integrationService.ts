...
export const integrationService = {
  ...
  async listEntityMaps(params?: { entity_type?: string; external_system?: string; internal_id?: string }): Promise<EntityMap[]> {
  ...
  async listOutbox(params?: { status?: SyncStatus; entity_type?: string; entity_id?: string }): Promise<OutboxItem[]> {
  ...
  async listErrors(params?: { is_resolved?: boolean; entity_type?: string; entity_id?: string }): Promise<IntegrationError[]> {
