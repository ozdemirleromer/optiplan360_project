...
import { TemplatesTab } from "./whatsAppAtoms";
...
type TabId = "overview" | "config" | "send" | "history" | "templates";
...
const TABS: { id: TabId; label: string; icon: React.ReactNode }[] = [
  ...
  { id: "templates", label: "Şablon Yönetimi", icon: <Zap size={16} aria-hidden="true" /> },
            ...
            >
              ...
              {fb.id !== "ALL" && (
                ...
                <span style={{ marginLeft: 6, opacity: 0.7 }}>
                  ...
                  ({statusCounts[fb.id as keyof typeof statusCounts] || 0})
