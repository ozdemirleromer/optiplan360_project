...
import { COLORS, RADIUS, Z_INDEX } from "../../components/Shared/constants";
...
export function OptiPlanningConfigModal({ isOpen, onClose, onSave, initialConfig }: Props) {
     ...
     return (
          <div style={{
               ...
               <Card ref={modalRef} style={{ width: "100%", maxWidth: 600, padding: 0, overflow: "hidden", maxHeight: "90vh", display: "flex", flexDirection: "column" }}
                    ...
                    <div style={{
                         ...
                         <h2 id="config-modal-title" style={{ margin: 0, fontSize: 18, color: COLORS.text }}>OptiPlanning Yapılandırması</h2>
                         <Button variant="ghost" size="sm" onClick={onClose} aria-label="Kapat" style={{ padding: 4 }}>
                              <X size={20} />
                         </Button>
                    </div>
                              ...
                              <div style={{ position: "relative" }}>
                                   ...
                                   <select
                                        ...
                                        style={{
                                             width: "100%", padding: "8px 12px 8px 36px",
                                             borderRadius: RADIUS.md, border: `1px solid ${COLORS.border}`,
                                             fontSize: 14, backgroundColor: COLORS.bg.surface, outline: "none"
                                        }}
                                   >
                         ...
                         {showAdvanced && (
                              <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 16, backgroundColor: COLORS.bg.elevated, padding: 16, borderRadius: RADIUS.md }}>
                                   ...
                                   <div style={{ display: "flex", flexDirection: "column", gap: 6 }}>
                                        ...
                                        <select value={optimizationMode} onChange={(e) => setOptimizationMode(e.target.value)} style={{ padding: "6px 10px", borderRadius: RADIUS.sm, border: `1px solid ${COLORS.border}`, backgroundColor: COLORS.bg.surface }}>
                                   ...
                                   <div style={{ display: "flex", flexDirection: "column", gap: 6 }}>
                                        ...
                                        <select value={grainPriority.toString()} onChange={(e) => setGrainPriority(parseInt(e.target.value))} style={{ padding: "6px 10px", borderRadius: RADIUS.sm, border: `1px solid ${COLORS.border}`, backgroundColor: COLORS.bg.surface }}>
