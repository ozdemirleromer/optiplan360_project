...
let didWarnMissingToastProvider = false;

const fallbackAddToast = () => {
  if (import.meta.env.DEV && !didWarnMissingToastProvider) {
    didWarnMissingToastProvider = true;
    console.warn("ToastContext used outside ToastProvider; toast will be ignored.");
  }
};
