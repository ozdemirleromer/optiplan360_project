    ...
    <div style={{ display: "grid", gap: 16 }}>
      ...
      <Card>
        <div style={{ marginBottom: 16, paddingBottom: 12, borderBottom: `1px solid ${COLORS.border}` }}>
          ...
          >
            <Clock size={16} color={COLORS.accent[400]} aria-hidden /> Gönderilmesi Beklenen
      ...
      {grouped.sent.length > 0 && (
        <Card>
          <div style={{ marginBottom: 16, paddingBottom: 12, borderBottom: `1px solid ${COLORS.border}` }}>
            ...
            >
              <CheckCircle size={16} color={COLORS.success.DEFAULT} aria-hidden /> Gönderilen
      ...
      {grouped.read.length > 0 && (
        <Card>
          <div style={{ marginBottom: 16, paddingBottom: 12, borderBottom: `1px solid ${COLORS.border}` }}>
            ...
            >
              <Eye size={16} color={COLORS.info.DEFAULT} aria-hidden /> Okunan Hatırlatıcılar (
              {grouped.read.length})
            </h3>
          </div>
          <div style={{ display: "grid", gap: 8 }}>
        ...
        <Card style={{ border: `1px solid ${COLORS.error.DEFAULT}`, background: COLORS.error.light }}>
          <div
            style={{
              marginBottom: 16,
              paddingBottom: 12,
              borderBottom: `1px solid ${COLORS.error.DEFAULT}`,
            }}
          >
            <h3
              style={{
