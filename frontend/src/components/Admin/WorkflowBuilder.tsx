          ...
          {workflows.map((workflow) => (
            <div
              ...
              style={{
                ...
                border: `1px solid ${selectedWorkflow?.id === workflow.id ? COLORS.primary.DEFAULT + "50" : COLORS.border}`,
                ...
                <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
                  <div
                    style={{
                      ...
                      background: workflow.active ? `${COLORS.success.DEFAULT}20` : `${COLORS.gray[400]}20`,
                      display: "flex",
                      alignItems: "center",
                      justifyContent: "center",
                      color: workflow.active ? COLORS.success.DEFAULT : COLORS.gray[400],
                    }}
                  >
                    <Zap size={20} />
                  </div>
                ...
                <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
                  ...
                  <button
                    ...
                    style={{
                      ...
                      borderRadius: 12,
                      border: "none",
                      background: workflow.active ? COLORS.success.DEFAULT : COLORS.gray[400],
                      cursor: "pointer",
                      position: "relative",
