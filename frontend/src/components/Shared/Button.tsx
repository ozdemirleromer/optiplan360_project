...
export const Button = ({
  ...
  const baseStyles: CSSProperties = {
    ...
    cursor: requestedInactiveState ? "not-allowed" : "pointer",
    display: "inline-flex",
    alignItems: "center",
    justifyContent: "center",
    gap: 8,
    transition: TRANSITIONS.fast,
    opacity: requestedInactiveState ? 0.65 : 1,
  ...
  return (
    <button
      type={type}
      disabled={requestedInactiveState}
      ...
      aria-label={ariaLabel}
      aria-disabled={requestedInactiveState}
    >
