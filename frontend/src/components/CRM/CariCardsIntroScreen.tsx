import { BarChart3, Clock, CreditCard, DollarSign, Shield, TrendingUp, Users, Zap } from "lucide-react";

import { navigateToAppPage } from "../../utils/appNavigation";
import { TopBar } from "../Layout/TopBar";
import { Button, Card } from "../Shared";
import { COLORS, primaryRgba, RADIUS, TYPOGRAPHY } from "../Shared/constants";
...
export function CariCardsIntroScreen({ onStart, onOpenReports }: CariCardsIntroScreenProps) {
  const handleOpenReports = () => {
    ...
    navigateToAppPage("reports-analytics", "cari-cards-intro");
  };
    ...
    <div style={{ minHeight: "100vh", background: COLORS.bg.main, fontFamily: TYPOGRAPHY.fontFamily.base }}>
      ...
      <div style={{ padding: "40px 20px" }}>
        <div style={{ maxWidth: "1200px", margin: "0 auto" }}>
          ...
          >
            <Users size={64} color={COLORS.primary} style={{ margin: "0 auto 20px" }} />
            ...
            >
              Müşterileriniz ve tedarikçilerinizin tüm bilgilerini merkezi bir sistemde yönetin. Faturalama, kredi
              takibi ve iletişimi basitleştirin.
            </p>
            ...
            {[
              {
                ...
                description:
                  "Tüm müşteri ve tedarikçi bilgilerini tek yerde saklayın. Kişi adları, iletişim bilgileri, adresler ve notlar.",
              },
              {
                icon: CreditCard,
                title: "Kredi Yönetimi",
                description:
                  "Müşteri kredi limitlerini tanımlayın ve gerçek zamanlı bakiye takibi yapın. Bekleyen ödemeleri izleyin.",
              },
              {
                icon: DollarSign,
                title: "Bakiye Takibi",
                description:
                  "Her müşteri ve tedarikçinin alacak/borç bakiyesini görüntüleyin. Finansal durumları analiz edin.",
              },
              {
                icon: Clock,
                title: "Ödeme Vadeleri",
                description:
                  "Farklı müşteriler için vade tanımlayın. Vade gelen ödemeleri takip edin ve hatırlatmalar alın.",
              },
              {
                icon: BarChart3,
                title: "Raporlama",
                description:
                  "Müşteri analiz, satış raporları ve ödemeler raporlarını görüntüleyin. Trend analizi yapın.",
              },
              {
                icon: Shield,
          ...
          <Card title="Cari Türleri">
            <div style={{ padding: "20px", display: "grid", gridTemplateColumns: "1fr 1fr", gap: "20px" }}>
              ...
              >
                <h4 style={{ fontSize: 14, fontWeight: 600, color: COLORS.text, marginBottom: "8px" }}>MÜŞTERİLER</h4>
