/**
 * OptiPlan 360 - Service Worker
 * PWA ve offline caching
 */

const CACHE_NAME = 'optiplan360-v1';
const STATIC_ASSETS = [
  '/',
  '/index.html',
  '/static/js/main.js',
...
// API cache strategy
const API_CACHE_NAME = 'optiplan360-api-v1';
const API_ROUTES = [
  '/api/v1/admin/stats',
...
async function syncOrders() {
  const db = await openDB('optiplan360-offline', 1);
